...
class CompanyPublishComponent extends StatelessWidget {
  const CompanyPublishComponent({Key key}) : super(key: key);
...
class CompanyForm extends StatefulWidget {
  CompanyForm({Key key}) : super(key: key);
...
class _CompanyFormState extends State<CompanyForm> {
  ...
  Future _doPublish() async {
    var res = await addCompany(params: {
      'post_title': _title,
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            //     child: Text('企业名称(不能为空)：', style: TextStyle(fontSize: 14.0))),
            Padding(
              padding: EdgeInsets.fromLTRB(20.0, 8.0, 20.0, 8.0),
              child: TextFormField(
            ...
            // Container(
            //   padding: EdgeInsets.fromLTRB(20.0, 8.0, 20.0, 8.0),
            //   child: Text('企业简介(不能为空)：', style: TextStyle(fontSize: 14.0)),
            // ),
            Padding(
              padding: EdgeInsets.fromLTRB(20.0, 8.0, 20.0, 8.0),
              child: TextFormField(
            ...
            // Container(
            //     padding: EdgeInsets.fromLTRB(20.0, 8.0, 20.0, 8.0),
            //     child: Text('企业地址(不能为空)：', style: TextStyle(fontSize: 14.0))),
            Padding(
              padding: EdgeInsets.fromLTRB(20.0, 8.0, 20.0, 8.0),
              child: TextFormField(
                keyboardType: TextInputType.text,
