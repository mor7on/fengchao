...
class SocialPublishComponent extends StatelessWidget {
  const SocialPublishComponent({Key key}) : super(key: key);
...
class _SkillFormState extends State<SkillForm> {
  ...
  Future _doPublish() async {
    var res = await addSocial(params: {
      'name': _title,
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () async {
                          await Navigator.pushNamed(context, '/popCategory', arguments: {'ids': _cateIds}).then((res) {
