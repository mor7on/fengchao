...
class SocialPostPublishComponent extends StatelessWidget {
  final Map arguments;
  const SocialPostPublishComponent({Key key, this.arguments}) : super(key: key);
...
class _SkillFormState extends State<SkillForm> {
  ...
  Future _doPublish() async {
    var res = await addSocialPost(params: {
      'post_title': _title,
      'post_content': _content,
      'post_address': _postAdress,
      'category_id': widget.arguments['id'],
