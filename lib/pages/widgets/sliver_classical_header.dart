...
class SliverCustomClassicalHeader extends SliverPersistentHeaderDelegate {
  ...
  Color makeStickyHeaderBottomTextColor(shrinkOffset, isIcon) {
    if (shrinkOffset <= 20) {
      ...
      final int alpha = ((1- shrinkOffset / (this.maxExtent - this.minExtent))  * 255)
          .clamp(0, 255)
          .toInt();
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: SafeArea(
                bottom: false,
                child: Container(
                  height: maxExtent != minExtent ? this.collapsedHeight : 50.0,
                  child: Row(
