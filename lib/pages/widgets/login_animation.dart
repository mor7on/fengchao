...
class LoginAnimation extends StatelessWidget {
  ...
  Widget _buildAnimation(BuildContext context, Widget child) {
    return new Padding(
      padding: buttomZoomOut.value <= 80 ? const EdgeInsets.only(top: 80.0) : containerCircleAnimation.value,
      child: new InkWell(
          onTap: () {
            _playAnimation();
          },
          child: new Hero(
            ...
            child: buttomZoomOut.value <= 300
                ? new Container(
                    ...
                    height: buttomZoomOut.value == 70 ? buttonSqueezeanimation.value : buttomZoomOut.value,
  ...
  Widget build(BuildContext context) {
    buttonController.addListener(() {
      if (buttonController.isCompleted) {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HomeComponent()));
      }
    });
