...
class MissionEditComponent extends StatelessWidget {
  const MissionEditComponent({Key key, this.arguments}) : super(key: key);
  final Map arguments;
...
class MissionForm extends StatefulWidget {
  MissionForm({Key key, this.detail}) : super(key: key);
...
class _MissionFormState extends State<MissionForm> {
  ...
  void initState() {
    super.initState();
    _missionType = widget.detail.type;
    _title = widget.detail.postTitle;
    _content = widget.detail.postContent;
    _expiredTime = widget.detail.expiredTime;
    _deposit = widget.detail.bail.coin;
    _postSalary = widget.detail.postSalary;
    _keywordsController.text = widget.detail.postKeywords;
    _keywordsIds = [];
  ...
  Future _doPublish() async {
    Map res = await editMission(params: {
      'id': widget.detail.id,
      'post_title': _title,
