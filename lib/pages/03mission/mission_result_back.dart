...
class MissionResultBackComponent extends StatefulWidget {
  MissionResultBackComponent({Key key, this.arguments}) : super(key: key);
  final Map arguments;

  @override
  _MissionResultBackComponentState createState() => _MissionResultBackComponentState();
}

class _MissionResultBackComponentState extends State<MissionResultBackComponent> {
  int _itemCount;
